...
collection: research
custom: 'true'
custom_remark: "For details, visit the [project page] (https://indie-fake-dataset.netlify.app/)"
...
For further details, refer to the [project page] (https://indie-fake-dataset.netlify.app/).
